...
public class Base64ToMultipartFile implements MultipartFile {
    ...
    /**
     * @param base64
     * This constructor to be used when we do not trust the dataURI for the actual content type and extension.
     */
    public Base64ToMultipartFile(String base64) throws IOException {
        this.fileContent = Base64.getDecoder().decode(base64.getBytes(StandardCharsets.UTF_8));
        this.contentType = URLConnection.guessContentTypeFromStream(new BufferedInputStream(new ByteArrayInputStream(this.fileContent)));
